var Polygon = Class.extend({
	...
	//assign the array staring from index 0.
	init: function(p) {
	...
	//Checks if a bullet is inside a polygon.
	//Returns true if a bullet is inside a polygon.
	//ox, oy are offset x and offset y.
